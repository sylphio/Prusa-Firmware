...
const char MSG_UNLOADING_FILAMENT_EXTRACT_EN[] PROGMEM = "Unload pre-extruding";
const char MSG_UNLOADING_FILAMENT_EXTRACT_CZ[] PROGMEM = "Unload pre-extruding";
const char * const MSG_UNLOADING_FILAMENT_EXTRACT_LANG_TABLE[LANG_NUM] PROGMEM = {
    MSG_UNLOADING_FILAMENT_EXTRACT_EN,
    MSG_UNLOADING_FILAMENT_EXTRACT_CZ
};
