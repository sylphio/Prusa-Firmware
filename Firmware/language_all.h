...
extern const char* const MSG_UNLOADING_FILAMENT_EXTRACT_LANG_TABLE[LANG_NUM];
#define MSG_UNLOADING_FILAMENT_EXTRACT LANG_TABLE_SELECT(MSG_UNLOADING_FILAMENT_EXTRACT_LANG_TABLE)
...
extern const char* const MSG_PREHEAT_BED_LANG_TABLE[LANG_NUM];
#define MSG_PREHEAT_BED LANG_TABLE_SELECT(MSG_PREHEAT_BED_LANG_TABLE)
